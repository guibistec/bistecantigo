...
// constructor
	...
	// Check values
		...
		$hour    = isset( $instance['hour'] ) ? esc_html( $instance['hour'] ) : '';
		$email    = isset( $instance['email'] ) ? esc_html( $instance['email'] ) : '';
	?>

	<p>
	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Título', 'moesia'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
	</p>

	<p><label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Digite o endereço', 'moesia' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e( 'Digite o número de telefone', 'moesia' ); ?></label>
    ...
    <p><label for="<?php echo $this->get_field_id( 'phone2' ); ?>"><?php _e( 'Digite o número do telefone de suporte', 'moesia' ); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id( 'phone2' ); ?>" name="<?php echo $this->get_field_name( 'phone2' ); ?>" type="text" value="<?php echo $phone2; ?>" size="3" /></p>

  <p><label for="<?php echo $this->get_field_id( 'hour' ); ?>"><?php _e( 'Digite o horário de funcionamento', 'moesia' ); ?></label>
<input class="widefat" id="<?php echo $this->get_field_id( 'hour' ); ?>" name="<?php echo $this->get_field_name( 'hour' ); ?>" type="text" value="<?php echo $hour; ?>" size="3" /></p>
	...
	function widget($args, $instance) {
		...
		if( ($address) ) {
			...
			echo '<span><i class="fa fa-home"></i>' . __('Endereço: ', 'moesia') . '</span>' . $address;
			echo '</div>';
		}
		if( ($phone) ) {
			echo '<div class="contact-phone">';
			echo '<span><i class="fa fa-phone"></i>' . __('Comercial: ', 'moesia') . '</span>' . $phone;
			echo '</div>';
		}
			if( ($phone2) ) {
			echo '<div class="contact-phone">';
			echo '<span><i class="fa fa-cog"></i>' . __('Suporte Técnico: ', 'moesia') . '</span>' . $phone2;
			echo '</div>';
		}
      if( ($hour) ) {
      echo '<div class="contact-phone">';
      echo '<span><i class="fa fa-clock-o"></i>' . __('Funcionamento: ', 'moesia') . '</span>' . $hour;
      echo '</div>';
    }
		if( ($email) ) {
