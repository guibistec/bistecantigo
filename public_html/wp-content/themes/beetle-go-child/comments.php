...
<div id="comments" class="comments-area">
    ...
    comment_form(
    	array(
    		'comment_field' => '<textarea id="comment" class="plain buffer" name="comment" rows="7" placeholder="' . esc_attr( __( 'Digite aqui sua mensagem', MOKAINE_THEME_NAME ) ) . '" aria-required="true"></textarea>',
    		'fields' => array(
